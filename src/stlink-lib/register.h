...
#define STLINK_REG_CM3_SHPR3                0xE000ED20
#define STLINK_REG_CM3_DEMCR                0xE000EDFC
#define STLINK_REG_CM3_DEMCR_TRCENA         (1 << 24)
#define STLINK_REG_CM3_DEMCR_DBGMON_ENA     (1 << 16)
#define STLINK_REG_CM3_DEMCR_VC_HARDERR     (1 << 10)
#define STLINK_REG_CM3_DEMCR_VC_BUSERR      (1 << 8)
#define STLINK_REG_CM3_DEMCR_HALTENA        (1 << 1)
#define STLINK_REG_CM3_DEMCR_MON_REQ        (1 << 19)
#define STLINK_REG_CM3_DEMCR_MON_STEP       (1 << 18)
#define STLINK_REG_CM3_DEMCR_MON_PEND       (1 << 17)
